...
const UploadBox = () => {
  return (
    <div className="bg-background-alternative flex flex-col items-center justify-center gap-5 py-10">
      ...
      <p className="caption1-medium text-label-alternative flex flex-col gap-1 text-center">
        <span>지원 형식: jpg, jpeg, png, heic</span>
        <span>최대 30개까지 업로드할 수 있어요.</span>
        <span>업로드 시 전체 파일 용량 합계는 50MB를 넘을 수 없어요.</span>
      </p>
    </div>
  );
};
