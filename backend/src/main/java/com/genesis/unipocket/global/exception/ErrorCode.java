...
public enum ErrorCode {
	...
	OAUTH_PROVIDER_NOT_CONFIGURED(
			HttpStatus.INTERNAL_SERVER_ERROR, "500_OAUTH_PROVIDER_NOT_CONFIGURED", "OAuth Provider 설정이 올바르지 않습니다."),
	...
	OAUTH_USERINFO_REQUEST_FAILED(
			HttpStatus.BAD_REQUEST, "400_OAUTH_USERINFO_REQUEST_FAILED", "OAuth 사용자 정보 조회에 실패했습니다."),
	INVALID_OAUTH_STATE(
			HttpStatus.BAD_REQUEST, "400_INVALID_OAUTH_STATE", "OAuth State 값이 유효하지 않습니다."),
	OAUTH_STATE_EXPIRED(
			HttpStatus.BAD_REQUEST, "400_OAUTH_STATE_EXPIRED", "OAuth State가 만료되었습니다.");
