...
public class TravelService {
    ...
    public TravelDetailResponse getTravelDetail(Long travelId) {
        ...
        List<WidgetDto> widgets = widgetRepository.findAllByTravelIdOrderByWidgetOrderAsc(travelId)
                .stream()
                .map(WidgetDto::from)
                .collect(Collectors.toList());
    ...
    public void updateWidgets(Long travelId, List<WidgetDto> newWidgets) {
        ...
        List<TravelWidget> widgetsToSave = newWidgets.stream()
                .map(dto -> TravelWidget.builder()
                        .travel(travel)
                        .widgetType(dto.type())
